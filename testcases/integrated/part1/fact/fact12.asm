...
#  la      $t0, msgprompt   	# load address of msgprompt into $t0
  lui      $1, 0x00001001 		# call code for print_string
  ori      $t0,$1,0x00000000 	# call code for print_string, t0= 1001 0000
...
#  li      $v0, 4            	# call code for print_string
  ...
  # scanf("%d", &number);
  lui	  $v0, 0
  ori 	  $v0,$v0, 12			# v0(Input register) is initialized to 12.
#  li      $v0, 5            	# call code for read_int
  ...
  lw      $s0, 4($sp)       # load final return val into $s0
							# s0 is the result register. 12! = 0x 1C8CFC00 = 479001600
